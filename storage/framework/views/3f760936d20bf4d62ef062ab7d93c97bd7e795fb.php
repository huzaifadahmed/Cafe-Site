...
<div class="bg-[url('/images/<?php echo e($item); ?>.jpg')] bg-cover w-80 h-80 rounded-xl">
    <div class="bg-neutral-600 bg-opacity-50 h-full w-full hover:bg-opacity-30 flex items-center justify-center transition">
        <a href="/order/<?php echo e($item); ?>" class="text-white text-4xl font-bold hover:text-neutral-300 transition"><?php echo e($item); ?></a>
    </div>
</div><?php /**PATH C:\Users\hdahmed\Desktop\Software Portfolio\Laravel\Restaurant-Site\resources\views/components/HomePage/ExploreOurMenu/card.blade.php ENDPATH**/ ?>